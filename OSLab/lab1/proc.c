 ...
 * @LastEditTime: 2022-03-22 16:20:19
 * @LastEditors: Opynicus
 * @Description: ToyOSLab1
 * @FilePath: \lab1\proc.c
 */
...
void HelpMenu()
{
    ...
    printf("* For Examples                                                                      *\n");
    printf("* run pid ---process pid turn into running state                                    *\n");
    printf("* rdy pid ---process pid turn into ready state                                      *\n");
    printf("* blk pid ---process pid turn into block state                                      *\n");
    printf("* kill pid ---process pid turn into unused state                                    *\n");
    printf("* show i --- 0 for all process info, 1 for block state info, 2 for ready state info *\n");
    printf("*************************************************************************************\n");
}
